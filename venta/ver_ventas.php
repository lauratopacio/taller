...
$fecha_fin=$_POST['fecha_fin'];
    $query="SELECT x.pk_venta,x.fecha_venta, x.fecha_fin,y.nombre,x.estatus,x.forma_pago, x.TOTAL FROM venta x, cliente y where y.pk_cliente=x.fk_cliente and x.fecha_venta>='$fecha_inicio' and x.fecha_venta<='$fecha_fin'";
    
    $resultado=$con->query($query);

  $query2 = mysql_query("SELECT * FROM venta where fecha_venta>='$fecha_inicio' and fecha_venta<='$fecha_fin'");
...
<form name="form1" method="post" action="ver_ventas.php">
 ...
 <h3>   
   Total de Ventas: <?php echo $no_rows2; ?>
  </h3>
</div>
