...
<!-- Inicio de ventana modal modificar -->
  <center> <h1>Modificar Servicio</h1></center>
 </center>
 <form class="form-horizontal" method="post" action="actualizar2.php">
<?php 
$pk_venta_producto=$_GET['pk_servicio'];
//conocer los datos del cliente qe realizo la venta
$query2="SELECT x.pk_servicio,x.fk_venta,x.mano_obra, x.costo from venta_servicio x, venta z where z.pk_venta=x.fk_venta and x.fk_venta='$max' ORDER BY x.mano_obra asc ";  
$resultado2=$con->query($query2);
    $row2=$resultado2->fetch_assoc();
 ?>
  <div class="form-group">
          <label class="col-md-4 control-label" for="codigo">C&oacutedigo</label>
          <div class="col-md-4">
          <input type="text" name="pk_servicio" id="pk_servicio"  class="form-control input-md" title="Codigo no se Modifica" readonly='radonly' restryng value="<?php echo $row2['pk_servicio'];?>" />
         </div>
        </div>

          <div class="form-group">
          <label class="col-md-4 control-label" for="fk_venta">Num. Venta</label>
          <div class="col-md-4">
          <input type="text" name="fk_venta" id="fk_venta"  class="form-control input-md" title="Codigo no se Modifica" readonly='readonly' restryng value="<?php echo $row2['fk_venta'];?>" />
         </div>
        </div>

         <div class="form-group">
          <label class="col-md-4 control-label" for="e">Mano de Obra</label>
          <div class="col-md-4">
          <input type="text" name="mano_obra" id="mano_obra"  class="form-control input-md" restryng value="<?php echo $row2['mano_obra'];?>">
         </div>
        </div>
        <div class="form-group">
          <label class="col-md-4 control-label" for="e">Costo</label>
          <div class="col-md-4">
          <input type="text" name="costo" id="costo"  class="form-control input-md" restryng value="<?php echo $row2['costo'];?>">
         </div>
        </div>
