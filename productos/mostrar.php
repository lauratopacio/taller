  ...
  require('../seguridad/seguridad.php'); 
    ...
    $dato=$_POST['dato'];
    $query="SELECT pk_producto,codigo,marca_carro,nombre_pieza,cantidad,costo,stock, imagen, estatus FROM producto WHERE  codigo LIKE '%$dato%' or marca_carro LIKE '%$dato%' or estatus LIKE '%$dato%' or nombre_pieza LIKE '%$dato%'";
