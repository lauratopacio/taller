...
require('../seguridad/seguridad.php'); 
	...
	$query="SELECT y.pk_cliente,x.TOTAL,x.pk_venta, x.fecha_venta, x.fecha_fin, x.estatus,y.telefono, x.forma_pago, y.nombre,y.ciudad, y.direccion, y.rfc FROM venta x, cliente y WHERE y.pk_cliente=x.fk_cliente and x.estatus='No pagado' and x.forma_pago='Credito' and y.estatus='Debe' group by y.pk_cliente";
        ...
        <td>
            ...
            <table class="table table-bordered table table-hover">
              <tr class="success">
                ...
                <td width="8%"><strong>Pagar con PayPal</strong></td>              
